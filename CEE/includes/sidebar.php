    ...
    <div class="app-header__menu">
        ...
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <li class="app-sidebar__heading">AVAILABLE SEMESTER EXAM'S</li>
                <li>
                <a href="#">
                ...
                <ul >
                 ...
                 <li class="app-sidebar__heading">TAKEN SEMESTER EXAM'S</li>
                <li>
                  <?php 
                    ...
                    { ?>
                        <a href="#" class="pl-3">You are not taking semester exam yet</a>
                    <?php }
