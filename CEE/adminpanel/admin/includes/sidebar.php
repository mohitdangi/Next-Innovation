                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li class="app-sidebar__heading">MANAGE Semester</li>
                                <li>
                                    <a href="#">
                                ...
                                <li class="app-sidebar__heading">MANAGE Semester Exam</li>
                                <li>
                                    <a href="#">
                                         <i class="metismenu-icon pe-7s-display2"></i>
                                         Exam
                                ...
                                <li class="app-sidebar__heading">Student's Result</li>
                                <li>
