<div class="app-main__outer">
        <div class="app-main__inner">
            ...
            <?php 
                   ...
                   <div class="app-page-title">
                    <div class="page-title-wrapper">
                        <div class="page-title-heading">
                            <div><b class="text-primary">RANKING of Student</b><br>
                                Semester Exam Name : <?php echo $selEx['ex_title']; ?><br><br>
                ...
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        <div><b>RANKING BY SEmester's EXAM</b></div>
                    </div>
                </div>
                </div> 
                ...
                <div class="main-card mb-3 card">
                    <div class="card-header">Semester's ExAM List
                    </div>
                    <div class="table-responsive">
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                            <thead>
                            ...
                            <tbody>
                              <?php 
                                ...
                                { ?>
                                    <tr>
                                      <td colspan="5">
                                        <h3 class="p-3">No Semester Exam Found</h3>
                                      </td>
                                    </tr>
                                <?php }
                               ?>
